...
import com.abdullahkaya.rest.repository.LocationRepository;
import com.abdullahkaya.rest.service.dto.LocationDTO;
import com.abdullahkaya.rest.service.mapper.LocationMapper;
...
class LocationResourceIT {
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.streetAddress(UPDATED_STREET_ADDRESS).postalCode(UPDATED_POSTAL_CODE).stateProvince(UPDATED_STATE_PROVINCE);
