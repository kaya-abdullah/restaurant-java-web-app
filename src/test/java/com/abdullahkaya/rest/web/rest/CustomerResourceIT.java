...
import com.abdullahkaya.rest.repository.CustomerRepository;
import com.abdullahkaya.rest.service.dto.CustomerDTO;
import com.abdullahkaya.rest.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().fullName(DEFAULT_FULL_NAME).phoneNumber(DEFAULT_PHONE_NUMBER).email(DEFAULT_EMAIL);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER).email(UPDATED_EMAIL);
        return customer;
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER).email(UPDATED_EMAIL);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER).email(UPDATED_EMAIL);
