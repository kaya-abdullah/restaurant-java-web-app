...
import com.abdullahkaya.rest.repository.CityRepository;
import com.abdullahkaya.rest.service.dto.CityDTO;
import com.abdullahkaya.rest.service.mapper.CityMapper;
...
class CityResourceIT {
    ...
    public static City createEntity(EntityManager em) {
        City city = new City().name(DEFAULT_NAME).phonePrefix(DEFAULT_PHONE_PREFIX);
        return city;
    }
    ...
    public static City createUpdatedEntity(EntityManager em) {
        City city = new City().name(UPDATED_NAME).phonePrefix(UPDATED_PHONE_PREFIX);
        return city;
    }
    ...
    void createCity() throws Exception {
        ...
        assertThat(testCity.getPhonePrefix()).isEqualTo(DEFAULT_PHONE_PREFIX);
    }
    ...
    @Test
    @Transactional
    void checkPhonePrefixIsRequired() throws Exception {
        int databaseSizeBeforeTest = cityRepository.findAll().size();
        // set the field null
        city.setPhonePrefix(null);
    ...
    void putNewCity() throws Exception {
        ...
        updatedCity.name(UPDATED_NAME).phonePrefix(UPDATED_PHONE_PREFIX);
        ...
        assertThat(testCity.getPhonePrefix()).isEqualTo(UPDATED_PHONE_PREFIX);
    }
    ...
    void partialUpdateCityWithPatch() throws Exception {
        ...
        partialUpdatedCity.phonePrefix(UPDATED_PHONE_PREFIX);
    ...
    void fullUpdateCityWithPatch() throws Exception {
        ...
        partialUpdatedCity.name(UPDATED_NAME).phonePrefix(UPDATED_PHONE_PREFIX);
