...
import com.abdullahkaya.rest.repository.DepartmentRepository;
import com.abdullahkaya.rest.service.dto.DepartmentDTO;
import com.abdullahkaya.rest.service.mapper.DepartmentMapper;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().name(DEFAULT_NAME).phoneNumber(DEFAULT_PHONE_NUMBER);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
        return department;
    }
    ...
    void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getPhoneNumber()).isEqualTo(DEFAULT_PHONE_NUMBER);
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
        ...
        assertThat(testDepartment.getPhoneNumber()).isEqualTo(UPDATED_PHONE_NUMBER);
    }
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
