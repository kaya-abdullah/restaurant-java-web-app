...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="hireDate"]`).type('2022-01-07T20:00').should('have.value', '2022-01-07T20:00');

      cy.get(`[data-cy="salary"]`).type('24764').should('have.value', '24764');

      cy.get(`[data-cy="commissionPct"]`).type('97402').should('have.value', '97402');

      cy.get(`[data-cy="identificationNumber"]`).type('CSS Manager blue').should('have.value', 'CSS Manager blue');
