...
describe('SeatingTable Management Component', () => {
  let comp: SeatingTableComponent;
  let fixture: ComponentFixture<SeatingTableComponent>;
  let service: SeatingTableService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'seating-table', component: SeatingTableComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SeatingTableComponent, '')
      .compileComponents();
